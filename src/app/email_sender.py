...
The email content is generated by substituting variables in an HTML template using the string.Template class.
The template file is located in the 'templates' directory relative to the current file.
The SMTP server details and login credentials are retrieved from environment variables using the dotenv library.

The send_email function takes the recipient's email address, message content, subject, and title as parameters.
